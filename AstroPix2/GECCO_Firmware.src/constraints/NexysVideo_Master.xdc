...
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVDS_25} [get_ports gecco_inj_chopper_n]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVDS_25} [get_ports gecco_inj_chopper_p]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVDS_25} [get_ports vb_data_n]
set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVDS_25} [get_ports vb_data_p]
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVDS_25} [get_ports vb_clock_n]
set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVDS_25} [get_ports vb_clock_p]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVDS_25} [get_ports vb_load_n]
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVDS_25} [get_ports vb_load_p]
...
#Clocks Hold <-> Interrupt
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS25} [get_ports interrupt]
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS25} [get_ports hold]
...
#SPI left
set_property -dict {PACKAGE_PIN A21 IOSTANDARD LVCMOS25} [get_ports spi_left_clk]
set_property -dict {PACKAGE_PIN B21 IOSTANDARD LVCMOS25} [get_ports spi_left_csn]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS25} [get_ports spi_left_miso0]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS25} [get_ports spi_left_miso1]
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS25} [get_ports spi_left_mosi]

#SPI right
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS25} [get_ports spi_right_mosi]
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS25} [get_ports spi_right_csn]
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS25} [get_ports spi_right_miso0]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS25} [get_ports spi_right_miso1]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS25} [get_ports spi_right_clk]
